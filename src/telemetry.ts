 ...
 * Telemetry events
 */
export type TelemetryEvents = 'proxy:start' | 'proxy:complete' | 'proxy:error'
/**
...
export class Telemetry {
  ...
  async trackCli(action: () => Promise<void> | void) {
    await this.trackSpan('proxy:start', 'proxy:complete', 'proxy:error', {}, action)
  }
}
